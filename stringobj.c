...
struct String *String_NewStr(const char *__restrict cstr)
{
...
void String_Del(struct String *const __restrict strobj)
{
	if( !strobj )
		return;
...
void String_InitStr(struct String *const __restrict strobj, const char *__restrict cstr)
{
	if( !strobj )
		return;
...
void String_AddChar(struct String *const __restrict strobj, const char c)
{
	if( !strobj )
		return;
...
void String_Add(struct String *const __restrict strobjA, const struct String *const __restrict strobjB)
{
...
void String_AddStr(struct String *const __restrict strobj, const char *__restrict cstr)
{
	if( !strobj or !cstr )
		return;
...
char *String_GetStr(const struct String *const __restrict strobj)
{
	return (strobj) ? strobj->CStr : NULL;
}

size_t String_Len(const struct String *const __restrict strobj)
{
	return (strobj) ? strobj->Len : 0;
}

void String_Copy(struct String *const __restrict strobjA, const struct String *const __restrict strobjB)
{
	if( !strobjA or !strobjB or !strobjB->CStr )
		return;
...
void String_CopyStr(struct String *const __restrict strobj, const char *__restrict cstr)
{
	if( !strobj or !cstr )
		return;
...
int32_t String_StrCmpCStr(const struct String *const __restrict strobj, const char *__restrict cstr)
{
...
int32_t String_StrCmpStr(const struct String *const __restrict strobjA, const struct String *const __restrict strobjB)
{
...
int32_t String_StrnCmpCStr(const struct String *const __restrict strobj, const char *__restrict cstr, const size_t len)
{
	if( !strobj or !cstr or !strobj->CStr )
		return -1;
...
int32_t String_StrnCmpStr(const struct String *const __restrict strobjA, const struct String *const __restrict strobjB, const size_t len)
{
	if( !strobjA or !strobjB or !strobjA->CStr or !strobjB->CStr )
		return -1;
...
bool String_IsEmpty(const struct String *const __restrict strobj)
{
